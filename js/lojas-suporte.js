window.FinckLojas = (() => {
  const BLOQUEADAS = [ {
    ...
    motivo: "A página chega vazia para quem não é um navegador real: o preço é " + "carregado depois, por uma API interna assinada. Não há nem preço base " + "para ler no HTML."
  }, {
    nome: "Amazon",
    dominios: [ "amazon.com.br", "amazon.com", "amzn.to", "a.co" ],
    motivo: "Responde com CAPTCHA para acessos vindos de servidor. Os Termos de Uso " + "da Amazon também proíbem leitura automatizada das páginas."
  }, {
    nome: "Temu",
    dominios: [ "temu.com" ],
    motivo: "Página montada por JavaScript e proteção anti-robô que exige sessão de " + "navegador real."
  }, {
    nome: "AliExpress",
    dominios: [ "aliexpress.com", "pt.aliexpress.com", "a.aliexpress.com", "aliexpress.us" ],
    motivo: "Proteção anti-robô do grupo Alibaba. Além disso o preço muda conforme " + "moeda, região e cupom aplicado."
  }, {
    nome: "SHEIN",
    ...
    motivo: "Exigem login. Não existe página pública de produto com preço para ser lida."
  }, {
    nome: "TikTok Shop",
    ...
    motivo: "O catálogo vive dentro do aplicativo. O link não abre uma página de " + "produto com preço."
  }, {
    nome: "Kwai Shop",
    ...
    dominios: [ "olx.com.br" ],
    motivo: "Anúncio de pessoa física, com proteção anti-robô e preço combinável. " + "O valor do anúncio raramente é o valor final."
  } ];
  const INSTAVEIS = [ {
    nome: "Mercado Livre",
    dominios: [ "mercadolivre.com.br", "mercadolibre.com", "mercadolivre.com", "meli.com.br", "mercadolivre.com/sec" ],
    motivo: "Às vezes responde, às vezes bloqueia o acesso vindo de servidor. " + "Quando responde, o preço lido é o do anúncio principal — pode mudar " + "conforme vendedor, frete e cupom."
  }, {
    nome: "Magazine Luiza",
    dominios: [ "magazineluiza.com.br", "magalu.com" ],
    motivo: "Publica o preço no HTML, mas tem proteção que às vezes barra o acesso."
  }, {
    ...
    motivo: "Publicam o preço no HTML, mas passam por proteção que pode barrar o acesso."
  }, {
    nome: "Marketplaces em geral",
    dominios: [],
    motivo: "Quando o mesmo produto tem vários vendedores, o preço lido é o da " + "oferta em destaque no momento — pode não ser o que você viu.",
    semDominio: true
  } ];
  const PROVAVEIS = [ {
    nome: "Lojas pequenas e médias",
    dominios: [],
    detalhe: "Feitas em Shopify, Nuvemshop, Loja Integrada, Tray ou WooCommerce. " + "São a maioria das lojas do Brasil e quase sempre funcionam.",
    semDominio: true
  }, {
  ...
  const casa = (host, dominios) => (dominios || []).some(d => host === d || host.endsWith(`.${d}`));
