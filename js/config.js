window.FINCK_CONFIG = {
  ...
  NIVEIS: [
    { level: 1,  titulo: "Primeiro passo",          xp: 0,     icone: "🌱", lema: "Você começou a observar as próprias escolhas." },
    { level: 2,  titulo: "Observador do orçamento", xp: 100,   icone: "👀", lema: "Começou a registrar e planejar o próprio dinheiro." },
    { level: 3,  titulo: "Planejador consciente",   xp: 300,   icone: "📝", lema: "Pensa antes de comprar — o preço virou pergunta." },
    { level: 4,  titulo: "Guardião das escolhas",   xp: 600,   icone: "🧭", lema: "Enxerga cada gasto como investimento ou desperdício." },
    { level: 5,  titulo: "Leitor dos números",      xp: 1000,  icone: "📚", lema: "Entende os números da própria realidade financeira." },
    { level: 6,  titulo: "Domador do impulso",      xp: 1500,  icone: "🛑", lema: "Controla o impulso antes que ele controle você." },
    { level: 7,  titulo: "Construtor de metas",     xp: 2100,  icone: "🎯", lema: "Busca metas com método, não com sorte." },
    { level: 8,  titulo: "Equilibrista financeiro", xp: 2800,  icone: "⚖️", lema: "Equilibra desejo e orçamento sem se enganar." },
    { level: 9,  titulo: "Analista de impacto",     xp: 3600,  icone: "🔎", lema: "Analisa cada compra e o impacto que ela produz." },
    { level: 10, titulo: "Guardião do tempo",       xp: 4500,  icone: "⏳", lema: "Reconhece o valor real de cada hora trabalhada." },
    { level: 11, titulo: "Consumidor responsável", xp: 5500,  icone: "🤝", lema: "Consome com consciência do impacto que gera." },
    { level: 12, titulo: "Protetor da reserva",     xp: 6600,  icone: "🏦", lema: "Guarda o que constrói e corta o que drena." },
    { level: 13, titulo: "Cuidador do futuro",      xp: 7800,  icone: "🛡️", lema: "Protege o amanhã nas decisões de hoje." },
    { level: 14, titulo: "Curador de recursos",     xp: 9100,  icone: "♻️", lema: "Faz cada recurso circular com propósito." },
    { level: 15, titulo: "Estrategista sustentável",xp: 10500, icone: "🌿", lema: "Planeja compras para durar, reparar e reaproveitar." },
    { level: 16, titulo: "Arquiteto do patrimônio", xp: 12000, icone: "🏗️", lema: "Constrói patrimônio com disciplina constante." },
    { level: 17, titulo: "Engenheiro das escolhas", xp: 13600, icone: "⚙️", lema: "Transforma decisões financeiras em um sistema coerente." },
    { level: 18, titulo: "Líder de impacto",        xp: 15300, icone: "🌎", lema: "Une prosperidade, propósito e responsabilidade." },
    { level: 19, titulo: "Mestre da consciência",  xp: 17100, icone: "💡", lema: "Domina a própria realidade sem perder de vista o coletivo." },
    { level: 20, titulo: "Embaixador da ODS 12",   xp: 19000, icone: "🏅", lema: "Consumo responsável virou prática diária. Nível máximo." },
  ],
